...
using Para2;
using ParaInt = Para2.Para<int, int>;
using ParaDouble = Para2.Para<double, double>;
using ParaString = Para2.Para<string, string>;
using ParaIntDouble = Para2.Para<int, double>;
...
namespace Para
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < pd.Length; ++i) pd[i] = new Para<double, double>(r.NextDouble(), r.NextDouble());
            Console.WriteLine("\nPara<double>:");
            ...
            ps[0] = new Para<string, string>("Bester", "Alfred");
            ...
            Console.WriteLine("O\'Brien\'s Tower".UsunApostrof());
            Console.WriteLine("O\'Brien\'s Tower".UsunApostrof('#'));
            Console.WriteLine("O\'Brien\'s Tower".UsunApostrof(c => ( c == '\'') ? '#' : c));
            Console.ReadKey();
        }
    }
    ...
    static class Rozszerzenia   //poniższa klasa nie może być zagnieżdżona w innej
    {
        ...
        //rozszerzenie z delegacją jako argumentem
